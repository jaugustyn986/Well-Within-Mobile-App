...
const slides = [
  ...
  {
    number: 3,
    // Spiral notepad on brown surface. Left edge (x=94) is dark wood until y≈220.
    // Was y=168 — baseline sat on the wooden surface, not on paper.
    // Moved to y=320 to be clearly within the bright notepad surface.
  ...
  {
    number: 5,
    // Paper on leafy background — top zone is clean bright paper.
    // Moved title slightly lower to y=240 for a comfortable margin.
