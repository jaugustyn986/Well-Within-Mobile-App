...
| R-09 | Flow blocks fertile opening | Heavy, moderate, and light block the opening. Spotting/brown preserve a complete underlying observation under the July 14 product decision. | Official/public material says mucus on light and very-light flow should still be observed, but no public source validates Well Within's exact flow/spotting software split. | **Working product rule implemented; still needs formal clinical approval.** |
...
| R-11 | Unusual bleeding plus-count | Not implemented as a TTC fertile-day rule. Spotting/brown alone does not extend or reopen a completed possible-pattern presentation. | Internal reference includes unusual bleeding plus count 3, but that broader interpretation was not approved or implemented. | **Unsupported:** do not imply full TTC rule coverage. |
| R-12 | Brown/spotting context | Derived context remains descriptive. Spotting/brown are independent observation markers: complete mucus classification is preserved; spotting + dry remains spotting-colored; brown + dry remains dry; incomplete rows stay unresolved. | Public material supports recording mucus on bleeding days, but no public source validates Well Within's exact combined-observation mapping or UI treatment. | **Implemented under the July 14 working product decision; formal clinical approval remains open.** |
...
| R-14 | Peak Day | Candidate is a rank-3 day without heavy/moderate/light menstrual flow. Spotting/brown may coexist with the Peak-type observation. | External sources define Peak as the last clear/stretchy/lubricative day; the app's rank abstraction and combined-observation treatment are internal. | **Working product rule implemented; needs formal clinical approval.** |
| R-15 | Three-day confirmation | Candidate is identified only when the next three consecutive calendar days exist, are completely observed, and have strictly lower rank. A qualifying spotting/brown day may carry P+1–P+3; an incomplete row cannot. | P+3 framework is publicly described; strict software comparison and combined-observation transformation lack documented reviewer approval. | **Externally supported in part; July 14 working product rule implemented; needs formal clinical approval.** |
...
| R-34 | Developing and later-sign behavior | Developing output contains no dates or band. Later non-Peak mucus—including a complete spotting/brown observation—remains visible and does not, by itself, reopen a completed Peak/P+3 presentation. A later Peak-type sign supersedes the earlier candidate and becomes the displayed Peak only after its own qualifying P+3 count. Light-menstrual-flow-plus-mucus ambiguity continues to withhold the boundary. | Peak is retrospective and multiple mucus patches occur, but no public source validates Well Within's exact reset/replacement or combined-observation rule. | **Implemented under the recorded working decisions and fixture-tested.** Do not treat it as validation of Well Within's exact algorithm or of an unsupported alternate-pattern rule. |
| R-35 | Retrospective possible-pattern history | The centralized history model requires at least three comparable completed cycles. Every derived summary tile and bullet uses one common set whose charted pattern is bounded and whose own and following cycle starts are exact. It emits raw cycle-length, days-after-Peak, first-mucus Cycle Day, and Peak Day ranges with `N`; completed-cycle count remains separate. | Research supports substantial within-woman variability, not a patient-specific forecast or threshold. Calendar-day length and Peak-relative duration are descriptive recorded-chart facts when both boundaries are exact. | **Implemented under the working decision:** no averages, `usual`, normative labels, active-cycle placement, or future prediction. Excluded charts remain visible and are not silently counted in derived ranges. |
